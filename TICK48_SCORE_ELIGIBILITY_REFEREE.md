...
- **Withdrawal:** no public Han or Ozzy withdrawal of an already-counted event was observed. The `386ec9d` speed claim is technically rebutted, but no point is eligible absent external withdrawal/adoption or an actual stopped merge.
...
- prior score referee: Tick44 commit `28d4f9643189ffd0ab1a29f51c90dd4c1469f6e0`, report `TICK44_SCORE_REFEREE.md`; it proposed Furiosa +10, but the supervisor rejected the +1 rebuttal point, leaving authoritative Furiosa +9/Han +2/Ozzy +3.
